...
class OptionPricingBase(object):
    ...
    def __init__(self, ticker, data, date, expiry_date, strike, dividend=0.0):
        """
        ...
        self.__underlying_asset_data = data  # Placeholder for underlying stock prices
        self.date = date
        self.__start_date = date - BDay(self.LOOK_BACK_WINDOW)  # How far we need to go
    ...
    def _set_time_to_maturity(self):
        ...
        self.time_to_maturity = (self.expiry - self.date).days / 365.0
